...
import { Avatar, Button, Card, Divider, FAB, Snackbar, Subheading, Text, Title } from "react-native-paper";
...
const UserInfoScreen = ({ navigation, route }: Props) => {
  ...
  const initialIsFriend = currentUserId ? user?.friends.includes(currentUserId) : false;
  ...
  return(
    <Frame back title={user?.displayName}
    ...
    >
      ...
      <View style={styles.profileInfo}>
        <Title style={styles.displayName}>{user?.displayName || "User Name"}</Title>
